...
class TestIdIntegrity(unittest.TestCase):
    ...
    def test_piece_ids_independent_sequence(self):
        ...
        p1 = lib.add_piece(iid, fmt="article", channel="medium")
        p2 = lib.add_piece(iid, fmt="short_post", channel="linkedin",
    ...
    def test_draft_and_published_are_views_of_pieces(self):
        ...
        lib = self._lib()
        iid = lib.add_idea("Idea", "Premise.", today="2026-01-01")
        d = lib.add_piece(iid, fmt="short_post", channel="linkedin", status="draft")
        lib.add_piece(iid, fmt="article", channel="medium", status="published")
    ...
    def test_roundtrip_save_and_reopen(self):
        ...
        pid = lib.add_piece(iid, fmt="short_post", channel="linkedin")
        lib.save()
